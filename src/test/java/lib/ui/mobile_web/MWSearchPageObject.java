...
public class MWSearchPageObject extends SearchPageObject {
    ...
    static {
        ...
        SEARCH_RESULT_BY_LIST_ITEM_SUBSTRING_TPL = "xpath://*[contains(@class,'wikidata-description')][contains(normalize-space(text()),'{SUBSTRING}')]";
        SEARCH_RESULT_LIST_ITEM_TITLE = "css:a.title h3";
        SEARCH_RESULT_BY_LIST_ITEM_TITLE_TPL = "xpath://a[contains(@class,'title')]/h3[text()='{TITLE}']";
