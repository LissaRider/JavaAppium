...
abstract public class MyListsPageObject extends MainPageObject {
    ...
    @Step("Get the article xpath by title '{articleTitle}'")
    ...
    @Step("Get the remove button of the article with the title '{articleTitle}'")
    ...
    @Step("Opening the reading list by name '{folderName}'")
    ...
    @Step("Waiting for the article with the title '{articleTitle}' to appear")
    ...
    @Step("Waiting for the article with the title '{articleTitle}' to disappear")
    ...
    @Step("Deleting the article '{articleTitle}'")
     ...
     */
    @Step("Closing the form 'Sync your saved articles popup?' for iOS")
